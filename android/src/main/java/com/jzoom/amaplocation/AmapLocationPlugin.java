 ...
 */
public class AmapLocationPlugin implements FlutterPlugin, MethodCallHandler, AMapLocationListener, ActivityAware {

    private String CHANNEL = "amap_location";
    ...
    public void onMethodCall(MethodCall call, Result result) {
        ...
        } else if ("getGpsStatus".equals(method)) {
            getGPSStatus(result);
        } else {
     ...
     * @return
     */
    private void getGPSStatus(final Result result) {
        boolean on = false;
        int locationMode = 0;
